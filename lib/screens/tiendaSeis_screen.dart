...
class Product6 {
  ...
  Product6({required this.title, required this.imageUrl, required this.price});
}

class TiendaSeis extends StatefulWidget {
  const TiendaSeis({super.key});

  @override
  State<TiendaSeis> createState() => _TiendaSeisState();
}

class _TiendaSeisState extends State<TiendaSeis> {
  final List<Product6> products = [
    Product6(
      title: 'Producto 1',
      imageUrl:
